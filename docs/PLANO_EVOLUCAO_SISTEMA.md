...
| 7 | Remover tabelas/código legado | ME-07 | PENDENTE | `migrations/` (nova), `frontend/src/services/medicoesService.js` | Tabelas `measurements`, `purchases` |
| 8 | Diário de Obra (RDO) | EF-01 | PENDENTE | Backend: `src/routes/diarios.js`, `src/controllers/DiarioController.js`, `src/services/DiarioService.js`. Frontend: `frontend/src/pages/DiarioObra.jsx`, `frontend/src/services/diariosService.js` | Funcionalidade crítica ausente |
| 9 | Tela de reset de senha | EF-04 | PENDENTE | `frontend/src/pages/ResetSenha.jsx`, `frontend/src/App.jsx` | Backend já implementado |
